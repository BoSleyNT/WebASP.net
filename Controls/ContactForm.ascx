...
<p>
    <strong style="color: #CCCC00; font-size: large">Mọi ý kiến thắc mắc hay đóng góp cho trang, xin vui lòng liền hệ theo cách sau :</strong></p>
    ...
    <ContentTemplate>
        ...
        <tr>
            <td colspan="3" style="font-weight: 700">Thông Tin Liên Hệ<br />
                Vui lòng nhập tên Email, Số điện thoại của bạn:&nbsp;&nbsp; <img class="auto-style10" src="../App_Themes/Monochrome/Images/Avenger.gif" /></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="auto-style6">Chủ đề bạn thắc mắc :</td>
